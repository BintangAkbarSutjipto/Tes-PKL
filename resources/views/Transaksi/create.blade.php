                    ...
                    @csrf
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('date') is-invalid @enderror" name="date" placeholder="Price" />
                                @error('date')
                                    <div class="invalid-feedback">
                                    <strong>{{ $message }}</strong>
                                    </div>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('quantity') is-invalid @enderror" name="quantity" placeholder="Name" />
                                @error('quantity')
                                    <div class="invalid-feedback">
                                    <strong>{{ $message }}</strong>
                                    </div>
